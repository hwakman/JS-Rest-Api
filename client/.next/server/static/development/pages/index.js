...
const url = 'http://localhost:8080/api'; // Query with raw sql

const RawQuery = async sql => {
  if (sql) {
    try {
      const Query = await axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(`${url}/rawQuery`, {
        sql
      });
      return Query.data;
    } catch (err) {
...
const TmpDel = (table, data) => {
  if (table && data) {
    axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(`${url}/tmpDel`, {
      table,
      data
    }).then(res => {
      console.log(res);
...
const AdminDel = async (table, condition) => {
  if (table && condition) {
    axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(`${url}/Delete`, {
      table,
      condition
    }).then(res => {
      console.log(res);
...
const TableColumn = async table => {
  if (table) {
    try {
      const colname = await axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(`${url}/TableColumn`, {
        table
      });
      return colname.data;
    } catch (err) {
...
var _jsxFileName = "/code/pages/component/roundLink.js";
...
/* harmony import */ var _component_roundLink__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./component/roundLink */ "./pages/component/roundLink.js");
...
class App extends react__WEBPACK_IMPORTED_MODULE_1__["Component"] {
  constructor() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(this, "setValue", async data => {
      try {
        await Object(_component_dbComponent__WEBPACK_IMPORTED_MODULE_2__["AddOne"])(`employee`, data);
        await alert(`member name "${data.name}" has added.`);
        await axios__WEBPACK_IMPORTED_MODULE_5___default.a.get('http://localhost:8080/').then(res => {
          this.setState({
            indexData: res.data
          });
        }).catch(err => {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(this, "editVal", async (table, target) => {
      console.log(table, target);
    });

    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(this, "delValue", async (table, target) => {
      try {
        await Object(_component_dbComponent__WEBPACK_IMPORTED_MODULE_2__["TmpDel"])(table, target);
  ...
  componentDidMount() {
    axios__WEBPACK_IMPORTED_MODULE_5___default.a.get('http://localhost:8080/').then(res => {
      this.setState({
        indexData: res.data
      });
    }).catch(err => {
  ...
  render() {
    return __jsx("div", {
      ...
      __self: this
    }, __jsx(_component_roundLink__WEBPACK_IMPORTED_MODULE_3__["default"], {
      __source: {
        fileName: _jsxFileName,
        lineNumber: 49
      },
...
const TableComp = props => {
  return __jsx("table", {
    ...
    onClick: props.editVal.bind(undefined, `employee`, res.id),
    __source: {
      fileName: _jsxFileName,
      lineNumber: 84
    },
    ...
    onClick: props.delValue.bind(undefined, `employee`, res.id),
    __source: {
      fileName: _jsxFileName,
      lineNumber: 91
    },
...
const InputForm = props => {
  const roleRef = new react__WEBPACK_IMPORTED_MODULE_1__["useRef"](null);
